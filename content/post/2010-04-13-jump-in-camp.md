...
I was lucky enough to be given the opportunity last week to attend [JumpInCamp][3], a developers conference/workshop ran by Microsoft in the beautiful setting of Zurich. The brief was as follows

> As a participant you will spend four unforgettable and instructive days in the [Panorama Resort & Spa Feusisberg][4], Switzerland – all-inclusive, for free. A live blog – to which you will contribute &#8211; will put all your friends and colleagues in the picture while you’re at the Camp.
...
Day 1 of camp started off too bright and early giving us our first introduction to the main topic of the week: [Windows Azure][5]. [Josh Holmes][6] gave us a great overview of the platform and the technology that powers it. Most interesting perhaps, was the system Microsoft has put in place to deploy Azure nodes around the world incredibly easily.

Next up was Faith Allington who gave us a presentation on the [Web Platform Installer (Web PI)][7] which provides an interesting interface for deploying web applications to IIS. The smart [phpBB][8] guys got a working version of their software into the web gallery during the week which can be found [here](http://area51.phpbb.com/phpBB/viewtopic.php?f=3&t=32736).

After lunch [Maarten Balliauw][9] gave us a great introduction to the [Windows Azure Storage platform][10] and instructions on how to use the excellent [SDK][11] he's developed for interacting with the platform. I'll discuss this further in a separate blog post.
...
*   Cow pat golf &#8211; Attempting to putt, chip a gold ball in the world's longest grass into a hole made out of cow pat. Credit goes to [Nils Aderman][12] who drove his ball about 20m past the hole with a putter :-)
...
Another early start proved more difficult than the previous day due to the white wine on offer the previous night. The first talk of the day was given by Corrado Cavalli who gave us an introduction to [Silverlight][14]. Whilst I'm not sold on the use of another third-party plugin required to view content in the browser (yes, I'm talking to you Flash) Alex pointed out that Silverlight can also be used to develop Windows Phone 7 apps. I think this is something I'll definitely be looking into in the next few weeks as all the tools needed to do this are free unlike some other competitors (\*cough\* Apple \*cough\*). There's a great tutorial for [Building a Windows Phone 7 twitter application using silverlight][15] if anyone is interested in this too :)

Next up was [Alex Weinstein][16] who introduced us to a fantastic tool that's coming out of Microsoft Labs called [Pivot][17]. It allows you to view interesting trends in data sets through a fantastic series of visualizations used to drill down on the data. I'd be very interested to see some tools built for this to export data from relational databases into the required format for pivot to view.
...
Jason Stowe from the SQL Server team gave us a great round up on the features available in SQL Server 2008 including [Spatial Data][20] and lots of other interesting tid bits. Then for the rest of the day everyone worked hard on their own individual projects before the final round up from Josh.
...
If anyone has any more photos please send me a [tweet][22]
 ...
 [1]: //deanclatworthy.com/img/uploads/2010/04/4499556648_5a5da0a301.jpg
 [2]: http://www.flickr.com/photos/derickrethans/4499556648/sizes/l/
 [3]: http://www.jumpincamp.com/en/Default.aspx
 [4]: http://www.jumpincamp.com/en/Camp/Default.aspx
 [5]: http://www.microsoft.com/windowsazure/windowsazure/
 [6]: http://www.joshholmes.com/blog/
 [7]: http://www.iis.net/webpi
 [8]: http://www.phpbb
 [9]: http://blog.maartenballiauw.be/
 [10]: http://msdn.microsoft.com/en-us/library/dd573356.aspx
 [11]: http://phpazure.codeplex.com/
 [12]: http://www.naderman.de/
 [13]: http://derickrethans.nl/
 [14]: http://www.silverlight.net/
 [15]: http://weblogs.asp.net/scottgu/archive/2010/03/18/building-a-windows-phone-7-twitter-application-using-silverlight.aspx
 [16]: http://www.alexweinstein.net/wordpress/
 [17]: http://www.getpivot.com
 [18]: http://ssrsphp.codeplex.com/
 [19]: http://www.deanclatworthy.com/?attachment_id=43
 [20]: http://www.microsoft.com/sqlserver/2008/en/us/spatial-data.aspx
 [21]: http://yuriy-zaytsev.smugmug.com/Professional/jumpincamp/11828007_YXa7U#836070437_nZ9YS
 [22]: http://www.twitter.com/deanclatworthy
