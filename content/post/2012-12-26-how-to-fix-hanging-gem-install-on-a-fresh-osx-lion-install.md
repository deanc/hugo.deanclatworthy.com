...
seo_title: "Fix Hanging Gem Install on OS X Lion"
description: "Fix slow or hanging gem installs on a fresh OS X Lion system by installing the Xcode command-line tools, RVM, and a current Ruby version."
author: Dean
layout: post
...
1.  Open up Xcode and go to XCode > Preferences and switch to the Downloads tab. Once there, install the command line tools if you haven't already.<a href="/img/uploads/2012/12/Screen-Shot-2012-12-26-at-1.18.35-PM.png"><img class="alignnone size-medium wp-image-259" alt="Xcode Downloads preferences with command line tools" src="/img/uploads/2012/12/Screen-Shot-2012-12-26-at-1.18.35-PM-300x219.png" width="300" height="219" /></a>
